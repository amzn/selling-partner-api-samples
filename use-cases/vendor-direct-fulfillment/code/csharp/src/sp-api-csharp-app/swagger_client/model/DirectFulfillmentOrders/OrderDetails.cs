...
namespace spApiCsharpApp.swaggerClient.Model.DirectFulfillmentOrders
{
    ...
    public partial class OrderDetails :  IEquatable<OrderDetails>, IValidatableObject
    {
        ...
        public OrderDetails(string customerOrderNumber = default(string), DateTime? orderDate = default(DateTime?), OrderStatusEnum? orderStatus = default(OrderStatusEnum?), ShipmentDetails shipmentDetails = default(ShipmentDetails), OrderDetailsTaxTotal taxTotal = default(OrderDetailsTaxTotal), PartyIdentification sellingParty = default(PartyIdentification), PartyIdentification shipFromParty = default(PartyIdentification), Address shipToParty = default(Address), PartyIdentification billToParty = default(PartyIdentification), List<OrderItem> items = default(List<OrderItem>))
        {
        ...
        public OrderDetailsTaxTotal TaxTotal { get; set; }
