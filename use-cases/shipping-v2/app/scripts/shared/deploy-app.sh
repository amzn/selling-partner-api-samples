...
AWS_ACCESS_KEY_ID=${access_key} AWS_SECRET_ACCESS_KEY=${secret_key} \
  aws cloudformation create-stack \
    ...
    --parameters \
      ...
      ParameterKey="OneClickShipment",ParameterValue="${sp_api_one_click_shipment}" \
      ...
      ParameterKey="SPAPIGetRatesLambdaFunctionHandler",ParameterValue="${get_rates_handler}" \
      ParameterKey="SPAPIGetAdditionalInputsLambdaFunctionHandler",ParameterValue="${get_additional_inputs_handler}" \
      ParameterKey="SPAPIOneClickShipmentLambdaFunctionHandler",ParameterValue="${one_click_shipment_handler}" \
      ParameterKey="SPAPISelectShipmentLambdaFunctionHandler",ParameterValue="${select_shipment_handler}" \
      ParameterKey="SPAPIPurchaseShipmentLambdaFunctionHandler",ParameterValue="${purchase_shipment_handler}" \
      ...
      ParameterKey="SPAPICancelShipmentLambdaFunctionHandler",ParameterValue="${cancel_shipment_handler}" \
      ParameterKey="SPAPIGetTrackingLambdaFunctionHandler",ParameterValue="${get_tracking_handler}" \
