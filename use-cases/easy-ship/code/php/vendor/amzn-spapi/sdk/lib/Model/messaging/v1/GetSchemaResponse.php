...
class GetSchemaResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets _links
     *
     * @return \SpApi\Model\messaging\v1\GetSchemaResponseLinks|null
     */
    public function getLinks(): ?\SpApi\Model\messaging\v1\GetSchemaResponseLinks
    {
     ...
     * Sets _links
     *
     * @param \SpApi\Model\messaging\v1\GetSchemaResponseLinks|null $_links _links
     *
     * @return self
     */
    public function setLinks(?\SpApi\Model\messaging\v1\GetSchemaResponseLinks $_links): self
    {
        if (is_null($_links)) {
