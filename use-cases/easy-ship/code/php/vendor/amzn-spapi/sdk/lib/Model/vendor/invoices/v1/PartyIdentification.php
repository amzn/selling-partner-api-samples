...
class PartyIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     */
    public function getAddress(): ?\SpApi\Model\vendor\invoices\v1\Address
    {
     ...
     * @return self
     */
    public function setAddress(?\SpApi\Model\vendor\invoices\v1\Address $address): self
    {
        if (is_null($address)) {
     ...
     *
     * @param array|null $tax_registration_details Tax registration details of the party.
     *
     * @return self
     */
