...
class FulfillmentTime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets start_time
     *
     * @param \DateTime|null $start_time The date, time in UTC of the fulfillment start time in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param \DateTime|null $end_time The date, time in UTC of the fulfillment end time in ISO 8601 format.
     *
     * @return self
     */
