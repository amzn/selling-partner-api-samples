...
class GetOrderRegulatedInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets payload
     *
     * @return \SpApi\Model\orders\v0\OrderRegulatedInfo|null
     */
    public function getPayload(): ?\SpApi\Model\orders\v0\OrderRegulatedInfo
    {
     ...
     * Sets payload
     *
     * @param \SpApi\Model\orders\v0\OrderRegulatedInfo|null $payload payload
     *
     * @return self
     */
    public function setPayload(?\SpApi\Model\orders\v0\OrderRegulatedInfo $payload): self
    {
        if (is_null($payload)) {
