...
class OperatingHour implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets start_time
     *
     * @param string|null $start_time The opening time, ISO 8601 formatted timestamp without date, HH:mm.
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param string|null $end_time The closing time, ISO 8601 formatted timestamp without date, HH:mm.
     *
     * @return self
     */
