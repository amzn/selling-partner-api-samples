...
class DistributionPackageContents implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets packages
     *
     * @param array|null $packages This is required only when `DistributionPackageType=PALLET`.
     *
     * @return self
     */
     ...
     * Sets products
     *
     * @param array|null $products This is required only when `DistributionPackageType=CASE`.
     *
     * @return self
     */
