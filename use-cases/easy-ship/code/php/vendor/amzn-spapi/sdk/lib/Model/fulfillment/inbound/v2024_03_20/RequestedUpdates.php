...
class RequestedUpdates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets boxes
     *
     * @param array|null $boxes A list of boxes that will be present in the shipment after the update.
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param array|null $items A list of all items that will be present in the shipment after the update.
     *
     * @return self
     */
