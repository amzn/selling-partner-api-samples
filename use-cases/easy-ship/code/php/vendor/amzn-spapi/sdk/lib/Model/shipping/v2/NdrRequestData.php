...
class NdrRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \DateTime|null $reschedule_date The date on which the Seller wants to reschedule shipment delivery, in ISO-8601 date/time format
     *
     * @return self
     */
     ...
     *
     * @param string|null $additional_address_notes Address notes to re-attempt delivery with.
     *
     * @return self
     */
