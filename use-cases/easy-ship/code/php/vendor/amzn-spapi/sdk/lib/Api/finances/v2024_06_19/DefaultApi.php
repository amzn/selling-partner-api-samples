...
class DefaultApi
{
     ...
     *  A date used for selecting transactions posted after (or at) a specified time. The date-time must be no later than two minutes before the request was submitted, in ISO 8601 date time format. (required)
     ...
     *  A string token used to select Marketplace ID. (optional)
