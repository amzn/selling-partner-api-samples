...
class TaxWithholdingPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date Fields with a schema type of date are in ISO 8601 date time format (for example GroupBeginDate).
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date Fields with a schema type of date are in ISO 8601 date time format (for example GroupBeginDate).
     *
     * @return self
     */
