...
class MarketplaceDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets marketplace_id
     *
     * @param string|null $marketplace_id The identifier of the marketplace where the transaction was made.
     *
     * @return self
     */
     ...
     *
     * @param string|null $marketplace_name The name of the marketplace where the transaction occurred.   Example: 'Amazon.com','Amazon.in'
     *
     * @return self
     */
