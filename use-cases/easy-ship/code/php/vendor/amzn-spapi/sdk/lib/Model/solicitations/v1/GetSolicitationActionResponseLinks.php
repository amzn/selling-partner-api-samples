...
class GetSolicitationActionResponseLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * @return \SpApi\Model\solicitations\v1\LinkObject
     */
    public function getSchema(): \SpApi\Model\solicitations\v1\LinkObject
    {
     ...
     * Sets schema
     *
     * @param \SpApi\Model\solicitations\v1\LinkObject $schema schema
     *
     * @return self
     */
    public function setSchema(\SpApi\Model\solicitations\v1\LinkObject $schema): self
    {
        if (is_null($schema)) {
