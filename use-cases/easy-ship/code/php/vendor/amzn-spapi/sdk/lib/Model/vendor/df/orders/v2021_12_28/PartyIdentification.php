...
class PartyIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     */
    public function getAddress(): ?\SpApi\Model\vendor\df\orders\v2021_12_28\Address
    {
     ...
     * @return self
     */
    public function setAddress(?\SpApi\Model\vendor\df\orders\v2021_12_28\Address $address): self
    {
        if (is_null($address)) {
     ...
     */
    public function getTaxInfo(): ?\SpApi\Model\vendor\df\orders\v2021_12_28\TaxRegistrationDetails
    {
     ...
     * @return self
     */
    public function setTaxInfo(?\SpApi\Model\vendor\df\orders\v2021_12_28\TaxRegistrationDetails $tax_info): self
    {
        if (is_null($tax_info)) {
