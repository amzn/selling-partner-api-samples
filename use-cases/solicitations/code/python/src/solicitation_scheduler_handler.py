...
def lambda_handler(event, context):
    ...
    for record in event["Records"]:
        ...
        seller_id = order_change_notification["SellerId"]
        order_id = order_change_notification["AmazonOrderId"]
        marketplace_id = order_change_notification["Summary"]["MarketplaceId"]
        order_earliest_delivery_date = order_change_notification["Summary"]["EarliestDeliveryDate"]
        order_latest_delivery_date = order_change_notification["Summary"]["LatestDeliveryDate"]
        ...
        try:
            ...
            logger.info(f"Schedule with name = {schedule_name} doesn't exist. Proceeding to create it.")
