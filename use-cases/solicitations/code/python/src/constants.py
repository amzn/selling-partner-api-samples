...
class Constants:
    ...
    REGION_ENDPOINT_MAPPING = {
        NA_REGION_CODE: (SP_API_NA_ENDPOINT, SP_API_NA_AWS_REGION),
        EU_REGION_CODE: (SP_API_EU_ENDPOINT, SP_API_EU_AWS_REGION),
        FE_REGION_CODE: (SP_API_FE_ENDPOINT, SP_API_FE_AWS_REGION),
        SANDBOX_REGION_CODE: (SP_API_NA_SANDBOX_ENDPOINT, SP_API_NA_AWS_REGION)
    }
