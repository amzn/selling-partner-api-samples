...
import io.swagger.client.model.feeds.ErrorList;
import io.swagger.client.model.feeds.Feed;
import io.swagger.client.model.feeds.FeedDocument;
import io.swagger.client.model.feeds.GetFeedsResponse;
...
public class FeedsApi {
    ...
    public static class Builder {
        ...
        public FeedsApi.Builder lwaAuthorizationCredentials(LWAAuthorizationCredentials lwaAuthorizationCredentials) {
            this.lwaAuthorizationCredentials = lwaAuthorizationCredentials;
            return this;
        }

        public FeedsApi.Builder endpoint(String endpoint) {
            this.endpoint = endpoint;
            return this;
        }

        public FeedsApi.Builder lwaAccessTokenCache(LWAAccessTokenCache lwaAccessTokenCache) {
            this.lwaAccessTokenCache = lwaAccessTokenCache;
            return this;
        }

        public FeedsApi.Builder disableAccessTokenCache() {
            this.disableAccessTokenCache = true;
            return this;
        }

        public FeedsApi.Builder rateLimitConfigurationOnRequests(RateLimitConfiguration rateLimitConfiguration){
            this.rateLimitConfiguration = rateLimitConfiguration;
            return this;
        }

        public FeedsApi.Builder disableRateLimitOnRequests() {
