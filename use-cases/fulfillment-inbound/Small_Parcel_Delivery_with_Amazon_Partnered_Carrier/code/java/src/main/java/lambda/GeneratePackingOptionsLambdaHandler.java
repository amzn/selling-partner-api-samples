 ...
 */
public class GeneratePackingOptionsLambdaHandler implements RequestHandler<GeneratePackingInput, GeneratePackingOptionsResponse> {

    @Override
    public GeneratePackingOptionsResponse handleRequest(GeneratePackingInput input, Context context) {
