...
public class ValidateInput {
    ...
    public static void validateGeneratePackingInput(ConfirmDeliveryWindowInput input) {
    ...
    public static void validateUpdateShipmentTrackingInput(UpdateShipmentTrackingInput input) {
        ...
        if (input.getTrackingId() == null || input.getTrackingId().isEmpty()) {
            throw new IllegalArgumentException("Tracking ID cannot be null or empty");
        }
        if (input.getBoxId() == null || input.getBoxId().isEmpty()) {
            throw new IllegalArgumentException("Box ID cannot be null or empty");
        }
    }

    // Validate the input parameters for the CancelInboundInput.
    public static void validateCancelInboundInput(CancelInboundInput input) {
    ...
    // Validate the input parameters for ListInboundPlanBoxesInput.
    public static void validateListInboundPlanBoxesInput(ListInboundPlanBoxesInput input) {
