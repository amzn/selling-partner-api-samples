...
def lambda_handler(event, context):
    ...
    notification_type = event.get(constants.SUB_NOTIFICATION_KEY_NOTIFICATION_TYPE)
    ...
    try:
        ...
        raise Exception("Create destination failed", e.__dict__)
    ...
    try:
        ...
        raise Exception("Create subscription failed", e.__dict__)
