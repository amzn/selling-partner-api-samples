...
class NotificationsApi(object):
    ...
    def create_subscription(self, body, notification_type, **kwargs):  # noqa: E501
        ...
        :param str notification_type: The type of notification.   For more information about notification types, see [the Notifications API Use Case Guide](doc:notifications-api-v1-use-case-guide). (required)
