## Deployment Guide
The Data Kiosk Sample Solution App provides all required resources to deploy to the AWS cloud a fully functional SP-API application that implements the [Data Kiosk use case](https://developer-docs.amazon.com/sp-api/v0/docs/data-kiosk-api-v2023-11-15-use-case-guide) end-to-end.
Follow the steps below to test the proposed solution, do changes and/or integrate it to your own product.
