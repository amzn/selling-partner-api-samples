# Overview
This folder contains the Java implementation of the error monitoring use case. The main components of this implementation are:
...
3. The [src/main/java/lambda](src/main/java/lambda) folder contains the backend code of the Lambda function.