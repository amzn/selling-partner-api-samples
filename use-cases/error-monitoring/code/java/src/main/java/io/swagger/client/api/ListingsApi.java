...
import io.swagger.client.model.ListingsApi.ListingsItemPatchRequest;
import io.swagger.client.model.ListingsApi.ListingsItemPutRequest;
import io.swagger.client.model.ListingsApi.ListingsItemSubmissionResponse;
...
public class ListingsApi {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<io.swagger.client.model.ListingsApi.Item> getListingsItemWithHttpInfo(String sellerId, String sku, List<String> marketplaceIds, String issueLocale, List<String> includedData) throws ApiException,LWAException {
