...
| A+ Content API | Submit an Image to A + Content | [Link](java/src/main/java/aplus/UploadImageForResourceRecipe.java) | -                                                                      | - |
...
| Data Kiosk | End-to-end query submission, notification handling, and scheduling | [Link](java/src/main/java/datakiosk/DataKioskQueryRecipe.java) | [Link](python/src/recipes/datakiosk/datakiosk_query_recipe.py) | - |
