...
|------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|------------------------------------------------------------------------|
| 🚚 ShippingGuru - Buy Shipping Challenge | [`shipping-guru/`](https://github.com/amzn/selling-partner-api-samples/tree/main/labs/workshops/shipping-guru) | Orders (v2026-01-01), Shipping (Buy Shipping) | Debug and optimize a seller’s shipping workflow using SP-API Buy Shipping |
